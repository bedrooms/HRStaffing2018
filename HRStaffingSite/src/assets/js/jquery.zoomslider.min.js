! function(s) {
    console.log("Init Function", s);
    function t(i, t) {
        console.log("Init Function IN");
        ...
        for (var o in a)
            ...
            console.log("this.settings Init Function-->", this.settings);
    ...
    s.extend(t.prototype, {
        init: function() {
            console.log("this.settings extend-->", this.settings);
